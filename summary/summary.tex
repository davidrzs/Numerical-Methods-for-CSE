...
std: :vector<double> ef1 ,  ef2 ;// errors for f1 resp. f21718t f 1 =a d a p t i v e p o l y i n t p( f1 , a , b ,  tol , N, &ef1 ) ;19t f 2 =a d a p t i v e p o l y i n t p( f2 , a , b ,  tol , N, &ef2 ) ;20VectorXdn1 =VectorXd: :LinSpaced( ef1 .s i z e( ) ,1 , ef1 .s i z e( ) ) ;
VectorXd n2 = VectorXd::LinSpaced( ef2 .s i z e( ) ,1 , ef2.size());
plt::figure ( ) ;
